...
(function () {
  ...
  const DICT = {
    en: {
      ...
      'get.title': 'Get Statiflix', 'get.lead': 'Free and open source. Two ways to install — pick whichever you prefer:',
      'get.m1badge': 'Recommended', 'get.m1title': 'From the Chrome Web Store',
      'get.m1sub': 'One click, auto-updates, no developer mode needed.',
      'get.m1cta': 'Add to Chrome — free',
      'get.m2badge': 'Manual', 'get.m2title': 'From the .zip',
      'get.m2cta': 'Download extension (.zip)',
      'get.m2s1': 'Download and <b>unzip</b> the file.',
      'get.m2s2': 'Open <code>chrome://extensions</code> and turn on <b>Developer mode</b> (top-right).',
      'get.m2s3': 'Click <b>Load unpacked</b> and select the unzipped <code>statiflix</code> folder.',
      'get.use': 'Then open <b>netflix.com</b> while signed in, click the <b>Statiflix</b> icon, and hit <b>Analyze my history</b>.',
    ...
    fr: {
      ...
      'get.title': 'Obtenir Statiflix', 'get.lead': 'Gratuit et open source. Deux façons de l’installer — choisissez la vôtre :',
      'get.m1badge': 'Recommandé', 'get.m1title': 'Depuis le Chrome Web Store',
      'get.m1sub': 'Un clic, mises à jour automatiques, sans mode développeur.',
      'get.m1cta': 'Ajouter à Chrome — gratuit',
      'get.m2badge': 'Manuel', 'get.m2title': 'Depuis le .zip',
      'get.m2cta': 'Télécharger l’extension (.zip)',
      'get.m2s1': 'Téléchargez puis <b>décompressez</b> le fichier.',
      'get.m2s2': 'Ouvrez <code>chrome://extensions</code> et activez le <b>Mode développeur</b> (en haut à droite).',
      'get.m2s3': 'Cliquez sur <b>Charger l’extension non empaquetée</b> et choisissez le dossier <code>statiflix</code>.',
      'get.use': 'Ouvrez ensuite <b>netflix.com</b> en étant connecté, cliquez l’icône <b>Statiflix</b>, puis <b>Analyser mon historique</b>.',
